...
import servidor.controladores.ControladorGestorCopiaCancionInt;


public class ServidorDeObjetos
{
    private static ControladorGestorCopiaCancionInt objCopia;
    ...
    {        
        ...
        objCopia = (ControladorGestorCopiaCancionInt) UtilidadesRegistroC.obtenerObjRemoto(direccionIpRMIRegistry,numPuertoRMIRegistry, "objServicioGestionCanciones");
        ...
        ControladorGestorCancionesImpl objRemotoGestionCanciones = new ControladorGestorCancionesImpl(objRepository,objRemotoGestionAdministradores,objCopia);
